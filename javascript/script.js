...
function updateTimer() {
  const targetDate = new Date("january 18, 2025 20:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '541141566846'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '541141566846'; // Número para el primer botón
